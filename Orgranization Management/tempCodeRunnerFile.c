// prio: things to do next time, funds, options for each positions, transfer positions
...
void fundsHistory() {
    ...
    if (fundsCount) {
        for (int i = 0; i < fundsCount; i++) {
            if (!strcpy(fund[i].category, "Income")) {
                printf("\n%d. [%s]\nAmount: +P%s\nPurpose: %s\n", i+1, fund[i].category, fund[i].amount, fund[i].purpose);
            } else if (!strcpy(fund[i].category, "Expense")) {
                printf("\n%d. [%s]\nAmount: -P%s\nPurpose: %s\n", i+1, fund[i].category, fund[i].amount, fund[i].purpose);
            } else {
                printf("\n%d. [%s]\nAmount: P%s\nPurpose: %s\n", i+1, fund[i].category, fund[i].amount, fund[i].purpose);
            }
...
void addFunds() {
    ...
    strcpy(fund[fundsCount].category, "Income");
    ...
    saveFunds();
    printf("Funds has been added successfully");
    printf("\nPress Enter to continue...");
    getchar();
    getchar();
    system("cls");
...
void deleteExpense() {
    ...
    strcpy(fund[fundsCount - 1].category, "\0");
    fund[fundsCount - 1].amount = 0;
    strcpy(fund[fundsCount - 1].purpose, "\0");
    fundsCount--;
    saveFunds();
...
void overrideFunds() {
    ...
    saveFunds();
    printf("Funds has been overrided successfully");
    printf("\nPress Enter to continue...");
    getchar();
    getchar();
    system("cls");
